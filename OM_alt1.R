...
dir.create(path = "input/cod4_alt1", recursive = TRUE)
dir.create(path = "output/runs/cod4_alt1", recursive = TRUE)
...
### use only data from 1987 and later
sr <- as.FLSR(window(stk_stf, start = 1987), model = "segreg")
...
### path
input_path <- paste0("input/cod4_alt1/", n, "_", n_years, "/")
